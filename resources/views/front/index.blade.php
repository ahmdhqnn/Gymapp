                ...
                <a href="{{ route('front.details', $itemNewGym->slug) }}" class="card">
                    <div class="flex flex-col rounded-3xl p-8 gap-6 bg-white">
                        <div class="title flex flex-col gap-2">
                            <h3 class="font-['ClashDisplay-SemiBold'] leading-19 tracking-05">{{ $itemNewGym->name }}</h3>
                        ...
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('assets/images/icons/Daily Time.svg') }}" class="w-10 h-10"
                                alt="icon">
                            <div class="flex flex-col gap-2">
                                ...
                                <p class="text-xs leading-14 tracking-05 opacity-50">
                                    ...
                                    {{ $itemNewGym->closed_time_at->format('h:i A') }}</p>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 w-fit">
                            <div class="w-16 h-16 rounded-full overflow-hidden">
                                <img src="{{ asset('assets/images/photos/image-1.png') }}"
                ...
                <div class="swiper-slide w-full">
                    <div
                        ...
                        <div class="flex items-center gap-3 w-fit">
                            <div class="w-16 h-16 rounded-full overflow-hidden">
                                <img src="{{ asset('assets/images/photos/image-2.png') }}"
                                    class="w-full h-full object-cover" alt="photos">
                            </div>
                            <div class="flex flex-col gap-2">
                                <p class="font-['ClashDisplay-SemiBold'] text-2xl leading-[29.52px] tracking-05">Tatang
                ...
                <div class="swiper-slide w-full">
                    <div
                        ...
                        <div class="flex items-center gap-3 w-fit">
                            <div class="w-16 h-16 rounded-full overflow-hidden">
                                <img src="{{ asset('assets/images/photos/image-3.png') }}"
                                    class="w-full h-full object-cover" alt="photos">
                            </div>
                            <div class="flex flex-col gap-2">
                                <p class="font-['ClashDisplay-SemiBold'] text-2xl leading-[29.52px] tracking-05">Tatang
